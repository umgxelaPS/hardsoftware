 ...
 * @author DAVID
 */
public class ModificarMarcaController implements Initializable {
    ...
    private void btnConsultar(ActionEvent event){
        ...
        try {
            ...
            Logger.getLogger(ModificarMarcaController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnModificar(ActionEvent event){
        ...
        consultar="UPDATE marca SET nombre=? WHERE id_marca='".concat(txtID.getText()).concat("'");
        try {
            preparar=con.prepareStatement(consultar);
