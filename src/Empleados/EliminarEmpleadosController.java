 ...
 * @author DAVID
 */
public class EliminarEmpleadosController implements Initializable {
    ...
    private void Eliminar(ActionEvent event){
        ...
        consultar="DELETE FROM empleado WHERE dpi='".concat(txtDpi.getText()).concat("'");
    ...
    @FXML   
    private void NuevaEliminacion(ActionEvent event){
        txtDpi.setText("");
        txtNombre.setText("");
        txtApellido.setText("");
        txtNacimiento.setText("");
