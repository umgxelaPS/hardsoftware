 ...
 * @author DAVID
 */
public class ModificarEmpleadosController implements Initializable {
    ...
    private void Modificar(ActionEvent event){
        ...
        consultar="UPDATE empleado SET nombre=?,apellido=?,fecha_nacimiento=?,cargo=?,salario=?,direccion=?,telefono=? WHERE dpi='".concat(txtDpi.getText()).concat("'");
        try {
            preparar=con.prepareStatement(consultar);
            ...
            preparar.setString(7, txtTelefono.getText());
